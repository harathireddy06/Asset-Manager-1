...
const translations: Record<string, { en: string; te: string }> = {
  ...
  "voice.cmd.reset":        { en: "Map reset",                  te: "మ్యాప్ రీసెట్ అయింది" },
  "voice.cmd.eta":          { en: "Announcing ETA",             te: "అంచనా సమయం చెప్తున్నాను" },
  "voice.cmd.route_set":    { en: "Route set!",                 te: "మార్గం సెట్ అయింది!" },
  "voice.cmd.from_set":     { en: "Starting point set",        te: "ప్రారంభ స్థానం సెట్ అయింది" },
  "voice.cmd.to_set":       { en: "Destination set",            te: "గమ్యస్థానం సెట్ అయింది" },
  "voice.cmd.error":        { en: "Mic error, try again",       te: "మైక్ లోపం, మళ్ళీ ప్రయత్నించండి" },
  "voice.cmd.no_route":     { en: "Set a route first",          te: "ముందు మార్గం సెట్ చేయండి" },
  ...
  "voice.cmd.unknown":      { en: "Try: start, stop, eta, reset, or a village name", te: "ప్రయత్నించండి: ప్రారంభించు, ఆపు, లేదా గ్రామం పేరు" },
